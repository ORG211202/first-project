...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/USER/Desktop/PythonWorkspace/Practice_Game01/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/USER/Desktop/PythonWorkspace/Practice_Game01/enemy.png")
...
while running:
    ...
    character_x_pos += to_x * dt  # 프레임별로 이동하는 값//이동속도 유지를 위한 처리
